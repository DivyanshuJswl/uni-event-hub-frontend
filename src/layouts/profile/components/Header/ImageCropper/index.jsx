...
import { Box, Fade, Backdrop, IconButton, Icon, Modal } from "@mui/material";
...
const ImageCropper = memo(
  ({ open, imageSrc, onClose, onCropComplete, aspect = 1, darkMode=false, isUploading = false }) => {
    ...
    // Memoized crop complete handler
